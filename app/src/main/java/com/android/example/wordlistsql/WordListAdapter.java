...
public class WordListAdapter extends RecyclerView.Adapter<WordListAdapter.WordViewHolder> {
    ...
    public WordListAdapter(Context context, WordListOpenHelper wordListOpenHelper, MainActivity mainActivity) {
        mInflater = LayoutInflater.from(context);
        mContext = context;


        this.wordListOpenHelper = wordListOpenHelper;
    ...
    public void onBindViewHolder(WordViewHolder holder, int position) {
        WordItem current = this.wordListOpenHelper.query(position);
    ...
    public int getItemCount() {
        ...
        return (int) this.wordListOpenHelper.count();
