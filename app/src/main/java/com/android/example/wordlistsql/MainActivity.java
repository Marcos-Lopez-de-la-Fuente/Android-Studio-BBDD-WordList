...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.wordListOpenHelper = new WordListOpenHelper(this);


        // Create recycler view.
        mRecyclerView = (RecyclerView) findViewById(R.id.recyclerview);
        // Create an mAdapter and supply the data to be displayed.
        mAdapter = new WordListAdapter(this, this.wordListOpenHelper, this);
        ...
        if (requestCode == WORD_EDIT) {
            if (resultCode == RESULT_OK) {
                ...
                if (!TextUtils.isEmpty(word)) {
                    ...
                    if (id == WORD_ADD) {
                        this.wordListOpenHelper.insert(word);
                        mAdapter.notifyDataSetChanged();
                    } else if (id >= WORD_EDIT) {
                        this.wordListOpenHelper.update(id, word);
                        mAdapter.notifyDataSetChanged();
                    }
